...
describe("PostHog", () => {
    ...
    describe("Data Ingestion", () => {
        test("Add contact", async () => {
            let contact = new Contact("CI", "CI Test User", "234-567-8901", "012-345-6789", "an@email.address", "206 WASHINGTON St SW, ATLANTA GA, 30334", null);
        ...
        test("Log Contact", async () => {
            let contact = new Contact("CI", "CI Test User", "234-567-8901", "012-345-6789", "an@email.address", "206 WASHINGTON St SW, ATLANTA GA, 30334", "TEST MESSAGE FROM CI");

            await expect(
                PostHog.logContact(contact, "MESSAGE WAS FROM CI/CD PIPELINE: TEST MESSAGE FROM CI")
